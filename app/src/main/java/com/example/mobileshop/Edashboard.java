    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rbtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Edashboard.this,ViewRequest.class);
        ...
        rbtn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Edashboard.this,AddAdmin.class);
                intent.putExtra("Phone", phone);
                startActivity(intent);
            }
        });
        rbtn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Edashboard.this,Status.class);
                intent.putExtra("Phone",phone);
                startActivity(intent);
            }
        });
        rbtn4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Edashboard.this,ServiceUpdate.class);
                intent.putExtra("Phone",phone);
                startActivity(intent);
            }
        });
